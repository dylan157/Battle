...
class Enemy(object):
	...
	print player.kills
	time.sleep(4)
        self.health = randint(int(static_player[1] * self.level*.4), int(static_player[1] * self.level*.6))
        self.attack = randint(int(static_player[1] * self.level*.4), int(static_player[1] * self.level*.6))
        self.defence = randint(int(static_player[1] * self.level*.4), int(static_player[1] * self.level*.6))
        self.life = True
